This project was bootstrapped with [Create React App](https://github.com/facebookincubator/create-react-app) according to the tutorial [here](https://facebook.github.io/jest/docs/tutorial-react.html).
